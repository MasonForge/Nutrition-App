...
macro_mode = st.selectbox("Select Macro Strategy", ["Default", "MM (60/25/15)", "High-Protein (65/15/20)", "Keto (10/20/70)", "Custom"])
...
elif macro_mode == "High-Protein (65/15/20)":
    protein_pct, carb_pct, fat_pct = 65, 15, 20
